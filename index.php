...
<html lang="en">
    ...
    <body >
        ...
        <nav class = "topnav" id = "myTopnav">
            ...
            <a href = "javascript:void(0);" class = "icon" onclick = "navRWD()">&#9776;</a>	  		
        </nav>
    <content>

        <div><h2>PHP Course</h2></div>
        <div>
            <form id = "courseForm" method = "post" action = "formhandeling.php" autocomplete = "on">
                <fieldset>
                    ...
                    <br><br>
                    <label>Gender:</label>
                    <input type="radio" name="gender" <?php if (isset($gender) && $gender == "female") echo "checked"; ?> checked="checked" value="Male"> Male
                ...
                <button id="s" type="submit" name="submit" value="Submit">Submit</button>   
